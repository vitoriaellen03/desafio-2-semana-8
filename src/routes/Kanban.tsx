        ...
        <div className="columns">
          <div className="column flex-row container-tasks justify-center gap-5 h-h-587 w-w-1051  bg-opacity-25 rounded-4xl">
            ...
            <div className="columns p-[20px]">
              ...
              {/* in-progress */}
              <div className=" column container-in-progress flex flex-col items-center gap-4 pb-2  lg:h-h-553 w-w-310 bg-1E293B bg-opacity-10 rounded-4xl">
              ...
              {/* done */}
              <div className=" column container-done flex flex-col items-center gap-4 pb-2 lg:h-h-553 w-w-310 bg-1E293B  bg-opacity-10 rounded-4xl">

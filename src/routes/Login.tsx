    ...
    <>
      ...
      <main className="text-sm relative md:text-base lg:flex lg:gap-20 lg:static xl:gap-44">
        <img
          src={logo}
          alt=""
          className="object-cover w-full h-656 md:h-1000 relative z-0 opacity-30 lg:w-520 xl:w-625 lg:h-656 lg:opacity-100 lg:static"
        />
        <div className="loginSection">
          ...
          <section className="flex flex-col gap-5">
            ...
            <button type="button" className="buttonDark self-center mt-6" onClick={handleLogin}>
              Login
            </button>
